...
public class WebAddress {
    ...
    public static final String MAIL_DELETE = BASE_URL + "/inbox/delete_item";
    public static final String MAIL_RATE = BASE_URL + "/inbox/rate_item";
    ...
    public static final String BATTLE_BATTLE_CHAINS = BASE_URL + "/arena/get_battle_chains";
